...
# If you have native dependencies, you'll need extra tools
 RUN apk add --update make gcc g++ python openjpeg openjpeg-dev freetype-dev libpng-dev jasper-dev tiff-dev jpeg-dev zlib-dev libjpeg libjpeg-turbo-dev libwebp-dev 
 RUN apk add --update --no-cache imagemagick && rm -rf /var/cache/apk/*
